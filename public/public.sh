...
wifi_2g_ssid="2.4"                                  # 2G 无线名称
wifi_5g_ssid="5"                                    # 5G 无线名称
wifi_guest_2g_ssid="2.4_Guset"                      # 2G 访客无线名称
wifi_guest_5g_ssid="5_Guest"                        # 5G 访客无线名称
wifi_password="abcde123456"                         # WIFI密码最少8位 空白为不设置
